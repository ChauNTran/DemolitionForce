...
////// Lighting:
////// Emissive:
                float4 node_8592 = _Time + _TimeEditor;
                float2 node_2741 = (i.uv0+node_8592.g*float2(0,-0.02));
                float4 _node_9303_var = tex2D(_node_9303,TRANSFORM_TEX(node_2741, _node_9303));
                float2 node_4775 = (i.uv0+node_8592.g*float2(0,-0.1));
                ...
                float3 emissive = (_node_7048.rgb+node_6216);
                float3 finalColor = emissive;
                float2 node_2351 = (i.uv0+node_8592.g*float2(0,0));
                ...
                return fixed4(finalColor,((1.0 - (node_6216*_node_9303_copy_copy_var.b*2.0))*_node_9303_copy_copy_copy_var.r*node_6216*2.0));
            }
            ENDCG
        }
        Pass {
