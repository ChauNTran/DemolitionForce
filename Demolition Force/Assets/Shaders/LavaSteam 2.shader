...
////// Emissive:
                ...
                float2 node_2741 = (i.uv0+node_7631.g*float2(0.00426,-0.00123));
                float4 _node_9303_var = tex2D(_node_9303,TRANSFORM_TEX(node_2741, _node_9303));
                float2 node_4775 = (i.uv0+node_7631.g*float2(0.0431,-0.143));
                ...
                float2 node_2351 = (i.uv0+node_7631.g*float2(0,0));
