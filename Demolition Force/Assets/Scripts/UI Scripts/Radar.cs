...
public class Radar : MonoBehaviour {
	...
	void CheckEnemy()
	{
		Collider[] hitColliders = Physics.OverlapSphere(player.transform.position, SightRange,layerToTrack);// 	ENEMY TANKS NEED NEED TO BE SET TO THE "TANKS" LAYER	
